if command -v dpkg 1>/dev/null; then
	spm add "$(dirname "$(realpath $0)")" \
		"python3-gi, gir1.2-gtk-4.0, gir1.2-gtksource-5, gir1.2-webkit-6.0, gir1.2-poppler-0.18, \
	...
	echo "\tpython3-gi gir1.2-gtk-4.0 gir1.2-gtksource-5 gir1.2-webkit-6.0 gir1.2-poppler-0.18"

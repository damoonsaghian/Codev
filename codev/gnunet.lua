...
function Gnunet:unpublish()
end

function Gnunet:download()
end

function Gnunet:pull()
end

function Gnunet:pull_request()
end

function Gnunet:create_website(remote_host, user)
	--[[

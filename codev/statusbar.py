...
'''
mem_info_file = io.open'/proc/meminfo'
mem_info = mem_info_file:read'a'
mem_total = tonumber(mem_info:match'MemTotal:%s+(%d+) kB')
mem_available = tonumber(mem_info:match'MemAvailable:%s+(%d+) kB')

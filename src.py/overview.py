...
# use udisks to format non'system devices with vfat or exfat (for files bigger than 4GB)
...
# for system devices: sudo mkfs.btrfs
#
...
# for non'system devices: https://docs.gtk.org/gio/method.Volume.mount.html
# for system device: sudo mount

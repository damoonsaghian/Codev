...
tpm2_create -Q -g sha256 -u seal.pub -r seal.priv -i /var/lib/luks/key1 -C prim.ctx
tpm2_load -Q -C prim.ctx -u seal.pub -r seal.priv -n seal.name -c seal.ctx
tpm2_evictcontrol -C o -c seal.ctx 0x81010001
# setup a new LUKS volume with a passphrase in tpm as key protector
loopdevice=$(losetup -f) && losetup $loopdevice enc.disk
# creating a pcr policy
tpm2_startauthsession -S session.ctx
tpm2_policypcr -Q -S session.ctx -l sha256:0 -L pcr0.sha256.policy
